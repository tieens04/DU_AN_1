...
{
    $sql = "select * from sanpham where gia_tri_khuyen_mai > 100000 order by id desc limit 0,5";
    $listsanpham = pdo_query($sql);
    return $listsanpham;
}
...
{
    if ($hinh != "") {
        $sql = "update sanpham set iddm='" . $iddm . "', name='" . $tensp . "', price='" . $giasp . "', so_luong='" . $soluong . "', danh_gia='" . $danhgia . "', idkm='" . $idsale . "', idmau='" . $idcolor . "', gia_tri_khuyen_mai='" . $giatrikhuyenmai . "', man_hinh='" . $manhinh . "', he_dieu_hanh='" . $hedieuhanh . "', camera_truoc='" . $cameratruoc . "', camera_sau='" . $camerasau . "',cpu='" . $cpu . "', ram='" . $ram . "', memory='" . $memory . "', pin='" . $pin . "' img='" . $hinh . "' where id=" . $id;
    } else {
        $sql = "update sanpham set iddm='" . $iddm . "', name='" . $tensp . "', price='" . $giasp . "', so_luong='" . $soluong . "', danh_gia='" . $danhgia . "', idkm='" . $idsale . "', idmau='" . $idcolor . "', gia_tri_khuyen_mai='" . $giatrikhuyenmai . "', man_hinh='" . $manhinh . "', he_dieu_hanh='" . $hedieuhanh . "', camera_truoc='" . $cameratruoc . "', camera_sau='" . $camerasau . "',cpu='" . $cpu . "', ram='" . $ram . "', memory='" . $memory . "', pin='" . $pin . "' where id=" . $id;
    }
