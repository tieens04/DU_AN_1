<section style="min-height: 60vh">
    <form action="index.php?act=viewcart" method="POST">
        <table class="listSanPham catalog mb">
            <?php
            if (isset($_SESSION['mycart']) && count($_SESSION['mycart']) > 0) {
                viewcart(1);
                echo '
            <a href="index.php"><input style="margin:10px" type="button" class="btn btn-primary" value="Về trang chủ"></a>
            <div style="position: absolute;top: 135px;right:180px"><input style="width:100px" type="submit" class="btn btn-primary" value="Đặt hàng" name="bill"></div>';
            } else {
                echo ' <tr>
            <th>STT</th>
            <th>Hình</th>
