                        ...
                        <div class="cd-signin-modal js-signin-modal">
                            ...
                            <div class="cd-signin-modal__container"> <!-- this is the container wrapper -->
                                ...
                                <div class="cd-signin-modal__block js-signin-modal-block" data-type="login">
                                    <!-- log in form -->
                                    <form id="form-login" class="cd-signin-modal__form" action="index.php?act=dangnhap"
                                        method="post">
                                        <p class="cd-signin-modal__fieldset">
                                            ...
                                            <input name="user"
                                                ...
                                                id="signin-username" type="text" placeholder="Username" required>
                                        </p>
                                        ...
                                        <p class="cd-signin-modal__fieldset">
                                            ...
                                            <input name="pass"
                                                class="cd-signin-modal__input cd-signin-modal__input--full-width cd-signin-modal__input--has-padding cd-signin-modal__input--has-border"
                                                id="signin-password" type="text" placeholder="Password" required>
                                            <a href="#0" class="cd-signin-modal__hide-password js-hide-password"
                                                style="font-family: Arial, Helvetica, sans-serif; font-size: 0.9vw;">Hide</a>
                                        </p>
                                ...
                                <div class="cd-signin-modal__block js-signin-modal-block" data-type="signup">
                                    ...
                                    <form class="cd-signin-modal__form" action="index.php?act=dangky" method="post">
                                        ...
                                        <p class="cd-signin-modal__fieldset">
                                            ...
                                            <input name="email"
                                                class="cd-signin-modal__input cd-signin-modal__input--full-width cd-signin-modal__input--has-padding cd-signin-modal__input--has-border"
                                                id="signup-email" type="email" placeholder="E-mail" required>
                                        </p>
                                        ...
                                        <p class="cd-signin-modal__fieldset">
                                            ...
                                            <input name="pass"
                                                class="cd-signin-modal__input cd-signin-modal__input--full-width cd-signin-modal__input--has-padding cd-signin-modal__input--has-border"
                                                id="signup-password" type="text" placeholder="Password" required>
                                            <a href="#0" class="cd-signin-modal__hide-password js-hide-password"
                                                style="font-family: Arial, Helvetica, sans-serif; font-size: 0.9vw;">Hide</a>
                                        </p>
